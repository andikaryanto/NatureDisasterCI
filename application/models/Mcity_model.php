...
class Mcity_model extends CI_Model {
    ...
    public function create_object_tabel($id, $name, $description, $provinceid, $ion, $iby, $uon, $uby)
    {
        $data = array(
            'id' => $id,
    ...
    public function create_object($id, $name, $description, $provinceid, $provincename, $ion, $iby, $uon, $uby)
    {
        $data = array(
            'id' => $id,
            'provinceid' => $provinceid,
    ...
    { 
        ...
        if(empty($model['provinceid']))
            $warning = array_merge($warning, array(0=>$resource['res_msg_province_can_not_null']));
    ...
    public function set_resources()
    {
        ...
        $resource['res_msg_province_can_not_null'] = $this->lang->line('err_msg_province_can_not_null');
