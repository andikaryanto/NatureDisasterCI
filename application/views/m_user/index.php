                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                      ...
                      <tbody>
                            ...
                            ?>
                              ...
                              <?php if($value->IsActive == 1) { ?>
															  <a class = "icon-custom-table-detail" href="javascript:void(0);" onclick="delete_user('<?php echo $value->Id?>','<?php echo $value->UserName?>')"><i class="fa fa-power-off"></i> <?php echo $resource['res_deactivate']?></a>
                              <?php } else { ?>
															  <a class = "icon-custom-table-detail" href="javascript:void(0);" onclick="activate_user('<?php echo $value->Id?>','<?php echo $value->UserName?>')"><i class="fa fa-power-off"></i> <?php echo $resource['res_activate']?></a>
                              <?php } ?>
                            </td>
													</tr>
											<?php
                    ...
                    <div class = "col-lg-2 icon-custom-table-header">
                      Total Data : <?php echo $totalrow - 1?> <!-- superadmin not included -->
                    </div>
                  </div>
                </div>
              </div>
