            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form method = "post" action = "<?php echo base_url('tdisasteroccur/addsave');?>">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea id="description" type="text" placeholder="<?php echo $resource['res_description']?>" class="form-control" name = "description" value="<?php echo $model['description']?>"></textarea> 
                        </div>
